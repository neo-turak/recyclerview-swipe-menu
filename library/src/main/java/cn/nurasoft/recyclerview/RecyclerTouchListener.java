package cn.nurasoft.recyclerview;
...
import cn.nurasoft.recyclerview.callback.OnActivityTouchListener;
import cn.nurasoft.recyclerview.callback.OnRowClickListener;
import cn.nurasoft.recyclerview.callback.OnRowLongClickListener;
import cn.nurasoft.recyclerview.callback.OnSwipeListener;
import cn.nurasoft.recyclerview.callback.OnSwipeOptionsClickListener;
import cn.nurasoft.recyclerview.callback.RecyclerTouchListenerHelper;
        ...
        public void run() {
            ...
            if (!bgVisible && touchedPosition >= 0 && !unClickableRows.contains(touchedPosition) && !isRViewScrolling) {
                if (longClickVibrate) {
                    ...
                    // do we really need to add vibrate service
                    vibe.vibrate(100);
                }
...
//        mSwipeListener = listener;
    ...
    public RecyclerTouchListener setOnRowClickListener(OnRowClickListener listener) {
        this.clickable = true;
        this.mRowClickListener = listener;
        return this;
    }

    public RecyclerTouchListener setOnRowClickListener(boolean clickable) {
        this.clickable = clickable;
        return this;
    }

    public RecyclerTouchListener setLongClickListener(boolean vibrate, OnRowLongClickListener listener) {
    ...
    public RecyclerTouchListener setLongClickListener(boolean longClickable) {
    ...
    public RecyclerTouchListener setOnSwipeOptionClickListener(int foregroundID, int backgroundID, OnSwipeOptionsClickListener listener) {
        this.swipeable = true;
    ...
    public RecyclerTouchListener setOnSwipeOptionClickListener(boolean value) {
